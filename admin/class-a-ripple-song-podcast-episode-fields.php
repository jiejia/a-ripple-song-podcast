...
class A_Ripple_Song_Podcast_Episode_Fields {
	...
	public function register_fields() {
		...
		Container::make( 'post_meta', 'ars_episode_details', __( 'Episode Details', 'a-ripple-song-podcast' ) )
			->where( 'post_type', '=', A_Ripple_Song_Podcast_Episodes::POST_TYPE )
			->set_context( 'normal' )
			->set_priority( 'high' )
			->add_fields(
				array(
					Field::make( 'text', 'audio_file', __( 'Audio File', 'a-ripple-song-podcast' ) )
					...
					Field::make( 'text', 'duration', __( 'Duration (seconds)', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Auto detected from "Audio File" on save.', 'a-ripple-song-podcast' ) )
						->set_attribute( 'type', 'number' )
						->set_attribute( 'min', '0' )
						->set_attribute( 'step', '1' )
						->set_attribute( 'readOnly', 'readOnly' ),
					Field::make( 'text', 'audio_length', __( 'Audio Length (bytes)', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Auto detected from "Audio File" on save.', 'a-ripple-song-podcast' ) )
						->set_attribute( 'type', 'number' )
						->set_attribute( 'min', '1' )
						->set_attribute( 'readOnly', 'readOnly' ),
					Field::make( 'text', 'audio_mime', __( 'Audio MIME Type', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Auto detected from "Audio File" on save.', 'a-ripple-song-podcast' ) )
						->set_default_value( 'audio/mpeg' )
						->set_attribute( 'readOnly', 'readOnly' ),
					Field::make( 'radio', 'episode_explicit', __( 'Explicit', 'a-ripple-song-podcast' ) )
						...
						->set_required( true ),
					Field::make( 'select', 'episode_type', __( 'Episode Type', 'a-ripple-song-podcast' ) )
						...
						->set_required( true ),
					Field::make( 'text', 'episode_number', __( 'Episode Number', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Optional but recommended. Integer.', 'a-ripple-song-podcast' ) )
						->set_attribute( 'type', 'number' )
						->set_attribute( 'min', '0' )
						->set_attribute( 'step', '1' ),
					Field::make( 'text', 'season_number', __( 'Season Number', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Optional. Integer.', 'a-ripple-song-podcast' ) )
						->set_attribute( 'type', 'number' )
						->set_attribute( 'min', '0' )
						->set_attribute( 'step', '1' ),
					Field::make( 'text', 'episode_author', __( 'Episode Author (override)', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Optional. Overrides channel author for this episode.', 'a-ripple-song-podcast' ) ),
					Field::make( 'image', 'episode_image', __( 'Episode Cover (square)', 'a-ripple-song-podcast' ) )
						->set_value_type( 'url' )
						->set_help_text( __( 'Optional. Square 1400–3000px. Overrides channel cover.', 'a-ripple-song-podcast' ) ),
					Field::make( 'text', 'episode_transcript', __( 'Transcript (optional)', 'a-ripple-song-podcast' ) )
					...
					Field::make( 'text', 'itunes_title', __( 'iTunes Title (optional)', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Optional. Apple Podcasts: overrides the episode title for <itunes:title>.', 'a-ripple-song-podcast' ) ),
					Field::make( 'text', 'episode_chapters', __( 'Chapters (Podcasting 2.0)', 'a-ripple-song-podcast' ) )
					...
					Field::make( 'text', 'episode_chapters_type', __( 'Chapters MIME Type', 'a-ripple-song-podcast' ) )
					...
					Field::make( 'complex', 'episode_soundbites', __( 'Soundbites (Podcasting 2.0)', 'a-ripple-song-podcast' ) )
						...
						->add_fields(
							array(
								Field::make( 'text', 'start_time', __( 'Start Time (seconds)', 'a-ripple-song-podcast' ) )
									->set_attribute( 'type', 'number' )
									->set_attribute( 'min', '0' )
								...
								Field::make( 'text', 'duration', __( 'Duration (seconds)', 'a-ripple-song-podcast' ) )
									...
									->set_attribute( 'step', '0.01' ),
								Field::make( 'text', 'title', __( 'Title (optional)', 'a-ripple-song-podcast' ) ),
							)
						),
					Field::make( 'text', 'episode_subtitle', __( 'Subtitle', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Optional. Short subtitle for iTunes.', 'a-ripple-song-podcast' ) ),
					Field::make( 'textarea', 'episode_summary', __( 'Summary', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Optional. Plain text summary for iTunes.', 'a-ripple-song-podcast' ) ),
					Field::make( 'text', 'episode_guid', __( 'Custom GUID (optional)', 'a-ripple-song-podcast' ) )
						->set_help_text( __( 'Optional. If empty, feed uses WP permalink as GUID.', 'a-ripple-song-podcast' ) ),
					Field::make( 'radio', 'episode_block', __( 'iTunes Block', 'a-ripple-song-podcast' ) )
					...
					Field::make( 'association', 'members', __( 'Members', 'a-ripple-song-podcast' ) )
					...
					Field::make( 'association', 'guests', __( 'Guests', 'a-ripple-song-podcast' ) )
